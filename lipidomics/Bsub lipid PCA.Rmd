...
plotIndiv(MyResult.pca, comp = c(2,3), legend = TRUE, title = 'B. subtilis - Flight vs Ground: PCA',
          group = BsubFG$Label, legend.title = 'Treatment',
          ellipse = TRUE, style = "ggplot2", ind.names = FALSE)
plotIndiv(MyResult.pca, comp = c(2,3,4), legend = TRUE, title = 'B. subtilis - Flight vs Ground: PCA',
          group = BsubFG$Label, legend.title = 'Treatment',
