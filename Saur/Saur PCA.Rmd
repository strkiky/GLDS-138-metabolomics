...
plotIndiv(MyResult.sipca, comp = c(1,2), legend = TRUE, title = 'S. aureus - Media vs Pellet: IPCA',
          group = SaurMP$Label, legend.title = 'Treatment',
          ellipse = TRUE, style = "ggplot2", ind.names = FALSE)
...
# Pellet - Flight vs Ground
X <- SaurFG[,3:ncol(SaurFG)]
MyResult.sipca <- sipca(X, ncomp = 4, mode="deflation", keepX = c(50,50,50,50))
plotIndiv(MyResult.sipca, comp = c(1,2), legend = TRUE, title = 'S. aureus - Flight vs Ground: IPCA',
          group = SaurFG$Label, legend.title = 'Treatment',
          ellipse = TRUE, style = "ggplot2", ind.names = FALSE)
plotIndiv(MyResult.sipca, comp = c(1,2,3), legend = TRUE, title = 'S. aureus - Flight vs Ground: IPCA',
          group = SaurFG$Label, legend.title = 'Treatment',
          ellipse = TRUE, style = "3d", ind.names = FALSE)
plotVar(MyResult.sipca, cutoff = 0.8)
MyResult.sipca$kurtosis 
