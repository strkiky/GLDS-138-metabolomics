...
# Anova
```{r}
anova_data <- SaurFG[,c("Label", "melibiose", "21709", "urea", "maltitol", "4976", "glycerol")]
library(tidyverse)
anova_data %>% pivot_longer(-Label, names_to = "Metabolite", values_to = "value") %>%
  mutate(Metabolite = factor(Metabolite, levels = c("melibiose", "21709", "urea", "maltitol", "4976", "glycerol"))) %>%
